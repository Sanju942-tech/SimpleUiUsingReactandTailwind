...
if(likedCourses.includes(course.id)){
    ...
    //insert krna hai ye course liked course mai
...
setLikedCourses((prev) => [...prev, course.id]);
    ...
    return (
        <div className='w-[300px] bg-black rounded-md bg-opacity-80 overflow-hidden'>
            <div className='relative'>
                <img src={course.image.url} alt='herapheri' />
